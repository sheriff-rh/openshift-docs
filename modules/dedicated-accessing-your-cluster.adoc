...
Further configuration details may be found
link:https://docs.openshift.com/container-platform/4.1/authentication/understanding-identity-provider.html#supported-identity-providers[here].
