...
To access the latest release, see xref:../../security/compliance_operator/compliance-operator-updating.html#olm-preparing-upgrade_compliance-operator-updating[Updating the Compliance Operator].
